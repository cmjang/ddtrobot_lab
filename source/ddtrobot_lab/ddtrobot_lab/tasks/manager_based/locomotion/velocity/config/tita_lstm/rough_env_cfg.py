...
import ddtrobot_lab.tasks.manager_based.locomotion.velocity.mdp as mdp
from ddtrobot_lab.tasks.manager_based.locomotion.velocity.mdp.my_terrains import HfFractalPerlinTerrainCfg
from ddtrobot_lab.tasks.manager_based.locomotion.velocity.velocity_env_cfg import (
    ActionsCfg,
...
# Pre-defined configs
##
from ddtrobot_lab.assets.ddtrobot import DDTROBOT_TITA_CFG  # isort: skip
...
Plane_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    size=(8.0, 8.0),
    border_width=20.0,
    num_rows=10,
    num_cols=20,
...
Perlin_TERRAIN_CFG = terrain_gen.TerrainGeneratorCfg(
    size=(60.0, 80.0),
    num_rows=1,
    num_cols=1,
    ...
    vertical_scale=0.005,
    # slope_threshold=0.9,
    sub_terrains={"perlin": HfFractalPerlinTerrainCfg()},
)


@configclass
class DDTRobotTitaLstmActionsCfg(ActionsCfg):
...
@configclass
class DDTRobotTitaLstmRewardsCfg(RewardsCfg):
...
@configclass
class DDTRobotTitaLstmRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    actions: DDTRobotTitaLstmActionsCfg = DDTRobotTitaLstmActionsCfg()
    rewards: DDTRobotTitaLstmRewardsCfg = DDTRobotTitaLstmRewardsCfg()
    ...
    def __post_init__(self):
        ...
        if self.__class__.__name__ == "DDTRobotTitaLstmRoughEnvCfg":
